...
パイプラインの削除 (かならず実行してください)

* [Step 15 - パイプラインの削除](#step-15---%E3%83%91%E3%82%A4%E3%83%97%E3%83%A9%E3%82%A4%E3%83%B3%E3%81%AE%E5%89%8A%E9%99%A4)
...
このワークショップで作成したパイプラインを削除します。GitHub レポジトリへ変更が push されると、このパイプラインが実行されるため、削除しないと課金が発生することに注意してください。

* コンソール画面左上の "**サービス**" → "**開発者用ツール**" → "**CodePipeline**" を選択します (画面上に表示されていない場合)
* パイプラインのリンクを選択して、パイプラインが一覧表示されている画面を表示します (画面上に表示されていない場合)
* 一覧の中から、ワークショップで作成したパイプラインをラジオボタンで選択します
* "**パイプラインを削除する**" ボタンを選択し、パイプラインを削除します

<img width="1144" alt="image" src="https://user-images.githubusercontent.com/95601557/176573148-b7934800-3701-4110-b1d3-e40111cece2b.png">
